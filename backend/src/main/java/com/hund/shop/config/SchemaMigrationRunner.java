...
public class SchemaMigrationRunner implements CommandLineRunner {
    ...
    private void migrateUserBirthDateColumn() {
        try {
            jdbcTemplate.execute(
                    """
                    ALTER TABLE users
            ...
            log.info("Added users.birth_date column if it did not exist");
        } catch (Exception e) {
            log.warn("Failed to migrate users.birth_date column automatically", e);
        }
    }
}
